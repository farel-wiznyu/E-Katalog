                    ...
                    <div class="card mb-0">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="account-box">
                                ...
                                <form class="form-horizontal" action="aksi/auth.php" method="POST">
                                    <div class=" account-content mt-4">

                                        <div class="form-group row">
                                            <div class="col-12">
                                                <label for="emailaddress">NIP/NISN</label>
                                                <input class="form-control" name="nip_nisn" type="text"
                                                    id="emailaddress" required="" placeholder="01234567">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <a href="page-recoverpw.html"
                                                    class="text-muted float-right"><small>Forgot
                                ...
                                <div class="row mt-4 pt-2">
                                    <div class="col-sm-12 text-center">
                                        <p class="text-muted mb-0">Don't have an account? <a href="page-register.html"
